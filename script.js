...
let pauseTime = 10000; // increased to 10 seconds pause after fully typing a quote
...
function typeWriter() {
    ...
    if (isDeleting) {
        ...
        // If we've deleted everything, start typing a new quote
        if (currentCharIndex === 0) {
            isDeleting = false;
            // Get a new random quote
            currentQuoteIndex = Math.floor(Math.random() * quotesArray.length);
